...
;define('connect4/app', ['exports', 'connect4/resolver', 'ember-load-initializers', 'connect4/config/environment'], function (exports, _resolver, _emberLoadInitializers, _environment) {
  'use strict';
...
;define('connect4/components/connect-4', ['exports'], function (exports) {
  'use strict';
...
;define('connect4/components/welcome-page', ['exports', 'ember-welcome-page/components/welcome-page'], function (exports, _welcomePage) {
  'use strict';
...
;define('connect4/helpers/app-version', ['exports', 'connect4/config/environment', 'ember-cli-app-version/utils/regexp'], function (exports, _environment, _regexp) {
  'use strict';
...
;define('connect4/helpers/pluralize', ['exports', 'ember-inflector/lib/helpers/pluralize'], function (exports, _pluralize) {
  'use strict';
...
;define('connect4/helpers/singularize', ['exports', 'ember-inflector/lib/helpers/singularize'], function (exports, _singularize) {
  'use strict';
...
;define('connect4/initializers/app-version', ['exports', 'ember-cli-app-version/initializer-factory', 'connect4/config/environment'], function (exports, _initializerFactory, _environment) {
  'use strict';
...
;define('connect4/initializers/container-debug-adapter', ['exports', 'ember-resolver/resolvers/classic/container-debug-adapter'], function (exports, _containerDebugAdapter) {
  'use strict';
...
;define('connect4/initializers/ember-data', ['exports', 'ember-data/setup-container', 'ember-data'], function (exports, _setupContainer) {
  'use strict';
...
;define('connect4/initializers/export-application-global', ['exports', 'connect4/config/environment'], function (exports, _environment) {
  'use strict';
...
;define('connect4/instance-initializers/ember-data', ['exports', 'ember-data/initialize-store-service'], function (exports, _initializeStoreService) {
  'use strict';
...
;define('connect4/resolver', ['exports', 'ember-resolver'], function (exports, _emberResolver) {
  'use strict';
...
;define('connect4/router', ['exports', 'connect4/config/environment'], function (exports, _environment) {
  'use strict';
...
;define('connect4/routes/game', ['exports'], function (exports) {
  'use strict';
...
;define('connect4/services/ajax', ['exports', 'ember-ajax/services/ajax'], function (exports, _ajax) {
  'use strict';
...
;define("connect4/templates/application", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "2gKiVabo", "block": "{\"symbols\":[],\"statements\":[[7,\"section\"],[11,\"id\",\"app\"],[9],[0,\"\\n  \"],[7,\"header\"],[9],[0,\"\\n    \"],[7,\"img\"],[11,\"src\",\"assets/logo.png\"],[11,\"alt\",\"Italian Trulli\"],[9],[10],[0,\"\\n  \"],[10],[0,\"\\n  \"],[7,\"article\"],[9],[0,\"\\n    \"],[1,[21,\"outlet\"],false],[0,\"\\n  \"],[10],[0,\"\\n  \"],[7,\"footer\"],[9],[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"float-left\"],[9],[0,\"| Michael Caunce - 23212438 \"],[10],[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"float-right\"],[9],[0,\"CIS3158 - Coursework Two |\"],[10],[0,\"\\n  \"],[10],[0,\"\\n\"],[10],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "connect4/templates/application.hbs" } });
});
;define("connect4/templates/components/connect-4", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "77Hljtxv", "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[0,\"\\n\"],[4,\"if\",[[23,[\"playing\"]]],null,{\"statements\":[[4,\"if\",[[23,[\"desktop\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[11,\"class\",\"text-center\"],[9],[0,\"\\n      \"],[7,\"button\"],[11,\"class\",\"restart\"],[3,\"action\",[[22,0,[]],\"start\"]],[9],[0,\"Play Again\"],[10],[0,\"\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[7,\"div\"],[11,\"class\",\"text-center\"],[9],[0,\"\\n      \"],[7,\"button\"],[11,\"class\",\"restart\"],[3,\"action\",[[22,0,[]],\"start\"]],[9],[0,\"Click or Shake to Play Again\"],[10],[0,\"\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]}],[4,\"if\",[[23,[\"winner\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[11,\"class\",\"game-message\"],[9],[0,\"\\n      '\"],[1,[21,\"winner\"],false],[0,\"'Player Won!\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[23,[\"draw\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[11,\"class\",\"game-message\"],[9],[0,\"\\n      Let's call it a draw.\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},{\"statements\":[[4,\"if\",[[23,[\"desktop\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[11,\"class\",\"text-center\"],[9],[7,\"h2\"],[9],[0,\"Rules of Play\"],[10],[7,\"br\"],[9],[10],[10],[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"text-left\"],[9],[0,\"\\n      \"],[7,\"ul\"],[9],[0,\"\\n        \"],[7,\"li\"],[9],[0,\"Point the cursor over the row you wish to drop your piece in\"],[10],[0,\"\\n        \"],[7,\"li\"],[9],[0,\"Left click to drop your piece\"],[10],[0,\"\\n        \"],[7,\"li\"],[9],[0,\"Connect four pieces vertically, horizontally or diagonally to win\"],[10],[0,\"\\n      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"text-center\"],[9],[0,\"\\n      \"],[7,\"button\"],[11,\"class\",\"start\"],[3,\"action\",[[22,0,[]],\"start\"]],[9],[0,\"Play!\"],[10],[0,\"\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[7,\"div\"],[11,\"class\",\"text-center\"],[9],[7,\"h2\"],[9],[0,\"Rules of Play\"],[10],[7,\"br\"],[9],[10],[10],[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"text-left\"],[9],[0,\"\\n      \"],[7,\"ul\"],[9],[0,\"\\n        \"],[7,\"li\"],[11,\"class\",\"mobile\"],[9],[0,\"Touch the row you wish to drop your piece in\"],[10],[0,\"\\n        \"],[7,\"br\"],[9],[10],[0,\"\\n        \"],[7,\"li\"],[11,\"class\",\"mobile\"],[9],[0,\"Connect four pieces vertically, horizontally or diagonally to win\"],[10],[0,\"\\n      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"text-center\"],[9],[0,\"\\n      \"],[7,\"button\"],[11,\"class\",\"start\"],[3,\"action\",[[22,0,[]],\"start\"]],[9],[0,\"Click or Shake Your Device to Play!\"],[10],[0,\"\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]}],[0,\"\\n\"],[7,\"canvas\"],[11,\"id\",\"stage\"],[11,\"width\",\"380\"],[11,\"height\",\"380\"],[9],[10],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "connect4/templates/components/connect-4.hbs" } });
});
;define("connect4/templates/game", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "C8hvQ4uW", "block": "{\"symbols\":[],\"statements\":[[1,[21,\"connect-4\"],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "connect4/templates/game.hbs" } });
});
;
...
;
          if (!runningTests) {
            require("connect4/app")["default"].create({"name":"connect4","version":"0.0.0+9cac5311"});
          }
