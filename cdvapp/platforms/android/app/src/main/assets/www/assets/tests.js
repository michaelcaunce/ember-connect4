...
define('connect4/tests/integration/components/connect-4-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';
...
define('connect4/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/connect-4.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/connect-4.js should pass ESLint\n\n2:8 - \'Ember\' is defined but never used. (no-unused-vars)\n166:7 - \'draw\' is assigned a value but never used. (no-unused-vars)\n398:7 - \'createjs\' is not defined. (no-undef)\n423:5 - \'createjs\' is not defined. (no-undef)\n424:5 - \'createjs\' is not defined. (no-undef)\n425:5 - \'createjs\' is not defined. (no-undef)\n426:5 - \'createjs\' is not defined. (no-undef)\n427:5 - \'createjs\' is not defined. (no-undef)\n432:10 - \'shake\' is not defined. (no-undef)\n433:9 - \'shake\' is not defined. (no-undef)\n453:21 - \'createjs\' is not defined. (no-undef)\n455:21 - \'createjs\' is not defined. (no-undef)\n500:27 - \'createjs\' is not defined. (no-undef)\n515:30 - \'createjs\' is not defined. (no-undef)\n533:5 - \'createjs\' is not defined. (no-undef)\n539:8 - \'shake\' is not defined. (no-undef)\n540:7 - \'shake\' is not defined. (no-undef)\n583:11 - \'y\' is already defined. (no-redeclare)\n593:9 - \'createjs\' is not defined. (no-undef)\n655:11 - \'createjs\' is not defined. (no-undef)\n657:11 - \'createjs\' is not defined. (no-undef)\n686:11 - \'createjs\' is not defined. (no-undef)\n687:11 - \'createjs\' is not defined. (no-undef)\n689:9 - \'createjs\' is not defined. (no-undef)\n690:9 - \'createjs\' is not defined. (no-undef)\n694:9 - \'createjs\' is not defined. (no-undef)\n715:11 - \'markers\' is already defined. (no-redeclare)');
  });
...
define('connect4/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('connect4/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'connect4/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('connect4/templates/components/connect-4.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'connect4/templates/components/connect-4.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('connect4/templates/game.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'connect4/templates/game.hbs should pass TemplateLint.\n\n');
  });
});
define('connect4/tests/lint/tests.lint-test', [], function () {
  'use strict';
